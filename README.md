...
| 科目 | 文件 | 章节 | 考点块 | 动画 |
| --- | --- | --- | --- | --- |
| 数据结构 | `data/11408/data-structure.js` | 8 章（绪论/线性表/栈队列数组/树/图/查找/排序/串） | 107 | 冒泡、快排、堆排、归并、二叉树遍历、图遍历、哈夫曼、KMP |
| 计算机组成原理 | `data/11408/computer-org.js` | 6 章（概述/数据表示/存储系统/指令系统/CPU/总线与I/O） | 68 | — |
| 操作系统 | `data/11408/operating-system.js` | 5 章（概述/进程线程/内存/文件/I/O） | 51 | 进程调度、页面置换 |
...
全库共 **712 个知识块**（概念 195 / 考点 176 / 表格 55 / 易错 45 / 公式 35 / 代码 27 / 动画 19 / 习题 119；另含图示 41 张），内容对齐王道考研 408 考纲与考研数学一大纲，可用于复习。
...
│   │   ├── data-structure.js   # 数据结构（8 章 107 块）
│   │   ├── computer-org.js     # 计算机组成原理（6 章 68 块）
│   │   ├── operating-system.js # 操作系统（5 章 51 块）
